...
#
# IMPORTANT:
# Do NOT put your TURN username/password directly in this file.
#
# Windows PowerShell:
#
#   $env:TURN_USERNAME="YOUR_NEW_USERNAME"
#   $env:TURN_CREDENTIAL="YOUR_NEW_CREDENTIAL"
#
# Then:
#
#   py -3.12 main.py
#
# These environment variables belong to the CURRENT HEAD laptop.
#
# ============================================================
...
def create_rtc_configuration():
    """
    Creates the server-side aiortc ICE configuration.
    """
...
def get_browser_ice_servers():
    """
    Returns ICE configuration for browser clients.

    TURN credentials are intentionally delivered to the
    camera browser because WebRTC TURN clients need them.
    """
...
async function startCamera() {
    ...
    try {
        ...
        // connectionstatechange will show it only
        // after real WebRTC connectivity.
...
def main():
    ...
    print(
        "9. Same main.py can be run by ANY team member."
    )
